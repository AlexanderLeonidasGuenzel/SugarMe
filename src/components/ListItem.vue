...
<template>
    <div class="flex justify-between mb-3 px-5" @click="$emit('click:item', props.child)">
      ...
      <!--<p class="mr-5"> <span class="text-nowrap"> {{ props.child.zucker  === undefined ? 'keine Informationen verfügbar' : props.child.zucker === 0 ? 'zuckerfrei!' : props.child.zucker + 'g' }} </span> </p>-->
